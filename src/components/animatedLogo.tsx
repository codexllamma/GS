...
export default function AnimatedLogo({
  ...
  useEffect(() => {
    ...
    const animations = svgRef.current.querySelectorAll(
  ...
  return (
    <div
      ...
      className={`inline-flex items-center justify-start leading-none cursor-pointer select-none ${className}`}
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <svg
        ref={svgRef}
        viewBox="90 90 1485 855"
      ...
      >
        <defs>
          ...
          <mask id="mask-E">
            <path
              d="M402 0H98Q90 0 90 9V634Q90 643 98 643H402Q411 643 411 635V623Q411 615 402 615H129Q120 615 120 607V350Q120 342 129 342H376Q385 342 385 334V322Q385 314 376 314H129Q120 314 120 306V36Q120 28 129 28H402Q411 28 411 20V8Q411 0 402 0Z"
              fill="white"
            />
          </mask>
          <mask id="mask-accent">
            <path
              d="M268 707H260Q252 707 246 715L154 827Q151 831 152.5 833.5Q154 836 158 836H188Q198 836 203 827L271 716Q276 707 268 707Z"
              fill="white"
            />
          </mask>
          <mask id="mask-R">
