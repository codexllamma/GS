  ...
  return (
    <LegalLayout title="Legal Notices & Disclaimers">
      <section>
        ...
        <p>
          All hièr.com content, trademarks, and logos are protected under Indian IP laws.
        </p>

        <h2>5.3 Third-Party Services</h2>
        <p>
          hièr.com integrates Razorpay, Supabase, Resend, and Google Analytics. We are not
        ...
        <p>
          ...
          Email: <a>support@hièr.store</a> <br />
