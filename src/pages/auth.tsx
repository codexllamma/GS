...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-100 via-white to-orange-200 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
            className="absolute -bottom-4 -left-4 w-8 h-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full opacity-30"
          />
          ...
          >
            <motion.div
              animate={{ rotate: [0,5,-5,0] }}
              transition={{ duration: 2, repeat: Infinity, repeatType: "reverse" }}
              className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-400 via-orange-500 to-rose-500 rounded-2xl mb-4 shadow-lg"
            >
              <span className="text-white font-bold text-xl tracking-wider">GS</span>
            </motion.div>
          ...
          <motion.form onSubmit={handleSubmit} className="space-y-6">
              ...
              {isSignUp && (
                ...
                >
                  ...
                  <input
                    ...
                    value={form.name}
                    onChange={handleChange}
                    className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 placeholder-gray-800"
                  />
                </motion.div>
              )}
            </AnimatePresence>
            ...
            >
              ...
              <input
                ...
                value={form.email}
                onChange={handleChange}
                className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
              />
            </motion.div>
            ...
            >
              ...
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className="w-full pl-12 pr-12 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
